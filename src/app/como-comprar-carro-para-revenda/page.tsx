...
export const metadata: Metadata = {
  title: "Como comprar carro para revenda sem prejuízo",
  description:
    "Guia prático de como comprar carro para revenda, evitar erros comuns e calcular preço máximo seguro antes de fechar negócio.",
};

export default function ComoComprarCarroParaRevendaPage() {
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 pb-28 sm:px-6 sm:py-10 sm:pb-10">
      <article className="space-y-6">
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm text-slate-700">Quando o preço de compra cabe na margem e o histórico está validado.</p>
        </section>
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">Quando NÃO vale a pena</h2>
          <p className="text-sm text-slate-700">Quando você precisa torcer para vender caro para fechar conta.</p>
        </section>
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">Erros comuns</h2>
          <p className="text-sm text-slate-700">Comprar por impulso, sem conta de custo total e sem blindagem.</p>
        </section>
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">Riscos ocultos</h2>
          <p className="text-sm text-slate-700">Leilão, sinistro, roubo e gravame podem converter lucro em prejuízo.</p>
        </section>

        <section className="rounded-2xl border border-amber-200 bg-amber-50 p-4">
          <h2 className="text-lg font-bold text-amber-900">Bloco de decisão</h2>
          <p className="text-sm text-amber-900/90">Se pagar acima de R$ 41.000, você entra no prejuízo.</p>
