...
export const metadata: Metadata = {
  title: "Consulta completa de veiculo pela placa",
  description:
    "Faça consulta completa do veiculo e veja risco oculto, preço máximo e margem.",
};

export default function ConsultaCompletaVeiculoPage() {
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 pb-28 sm:px-6 sm:pb-10">
      <article className="space-y-6">
        <section className="rounded-2xl border border-slate-200 bg-white p-5">
          <h1 className="text-2xl font-extrabold text-slate-900 sm:text-3xl">
            Consulta completa de veiculo pela placa
          </h1>
