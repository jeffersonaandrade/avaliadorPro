...
export const metadata: Metadata = {
  title: "Quanto pagar em carro usado para revenda?",
  description:
    "Aprenda quanto pagar em carro usado para revender com margem real e sem cair no erro de comprar só pela FIPE.",
};

export default function QuantoPagarCarroUsadoPage() {
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 pb-28 sm:px-6 sm:py-10 sm:pb-10">
      <article className="space-y-6">
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <h1 className="text-2xl font-extrabold text-slate-900 sm:text-3xl">
            Quanto pagar em um carro usado para revender?
          </h1>
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm text-slate-700">Quando o preço de compra respeita custos, risco e margem alvo.</p>
        </section>
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">Quando NÃO vale a pena</h2>
          <p className="text-sm text-slate-700">Quando o preço está perto da FIPE e não sobra lucro líquido.</p>
        </section>
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">Erros comuns</h2>
          <p className="text-sm text-slate-700">Confiar na FIPE, ignorar histórico e esquecer custos de operação.</p>
        </section>
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">Riscos ocultos</h2>
          <p className="text-sm text-slate-700">Leilão, sinistro e gravame reduzem valor real e aumentam tempo de giro.</p>
        </section>

        <section className="rounded-2xl border border-amber-200 bg-amber-50 p-4">
          <h2 className="text-lg font-bold text-amber-900">Bloco de decisão</h2>
          <p className="text-sm text-amber-900/90">Se pagar acima de R$ 37.000, você entra no prejuízo.</p>
