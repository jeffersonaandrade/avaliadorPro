...
export const metadata: Metadata = {
  title: "Erros ao comprar carro usado para revenda",
  description:
    "Veja os principais erros ao comprar carro usado para revenda e como evitar prejuízo com conta de preço máximo seguro.",
};

export default function ErroAoComprarCarroUsadoPage() {
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 pb-28 sm:px-6 sm:py-10 sm:pb-10">
      <article className="space-y-6">
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <h1 className="text-2xl font-extrabold text-slate-900 sm:text-3xl">
            Quais são os erros ao comprar carro usado?
          </h1>
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm text-slate-700">Quando existe margem e o risco do histórico foi validado.</p>
        </section>
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">Quando NÃO vale a pena</h2>
          <p className="text-sm text-slate-700">Quando você compra no limite e qualquer surpresa vira prejuízo.</p>
        </section>
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">Erros comuns</h2>
          <p className="text-sm text-slate-700">Pagar FIPE, ignorar custos e não validar histórico da placa.</p>
        </section>
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">Riscos ocultos</h2>
          <p className="text-sm text-slate-700">Leilão, sinistro e gravame reduzem preço de saída e liquidez.</p>
        </section>

        <section className="rounded-2xl border border-amber-200 bg-amber-50 p-4">
          <h2 className="text-lg font-bold text-amber-900">Bloco de decisão</h2>
          <p className="text-sm text-amber-900/90">Se pagar acima de R$ 39.000, você entra no prejuízo.</p>
