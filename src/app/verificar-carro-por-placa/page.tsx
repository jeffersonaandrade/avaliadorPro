...
export const metadata: Metadata = {
  title: "Como verificar carro por placa antes de comprar",
  description:
    "Verifique histórico de carro por placa e evite prejuízo em compras para revenda.",
};

export default function VerificarCarroPorPlacaPage() {
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 pb-28 sm:px-6 sm:pb-10">
      <article className="space-y-6">
        <section className="rounded-2xl border border-slate-200 bg-white p-5">
          <h1 className="text-2xl font-extrabold text-slate-900 sm:text-3xl">
            Como verificar carro por placa antes de comprar
          </h1>
